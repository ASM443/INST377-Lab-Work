    ...
    */
    ...
    if (chartData?.length > 0) { // the question mark in this means "if this is set at all"
      ...
      form.addEventListener('input', (event) => {
        ...
        //console.log("Here" + currentList[0].name);
        const filteredlist = currentList.filter(x => x!=null ? x.name.toUpperCase().includes(event.target.value.toUpperCase()) : "");
      ...
      form.addEventListener('submit', (submitEvent) => {
        ...
        changeChart(myChart, shapeDataForLineChart(currentList));
